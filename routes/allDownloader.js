...
router.get('/soundcloud', async (req, res) => {
    ...
    if (!url) {
        return res.status(400).json({
            status: 400,
            message: "URL soundcloud tidak diberikan!"
        });
    }
    try {
        ...
        res.status(500).json({ error: 'Gagal mengambil data soundcloud.' });
    }
});
...
router.get('/twitter', async (req, res) => {
    ...
    if (!link) {
        return res.status(400).json({
            status: 400,
            message: "Link twitter tidak diberikan!"
        });
    }
    try {
        ...
        res.status(500).json({ error: 'Gagal mengambil data twitter.' });
    }
});
...
router.get('/facebook', async (req, res) => {
    ...
    if (!link) {
        return res.status(400).json({
            status: 400,
            message: "Link facebook tidak diberikan!"
        });
    }
    try {
        const result = await facebook(link);
        res.json(result);
    } catch (error) {
        console.error('Error fetching facebook data:', error);
        res.status(500).json({ error: 'Gagal mengambil data facebook.' });
    }
});
...
router.get('/igdl', async (req, res) => {
    ...
    if (!url) {
        return res.status(400).json({
            status: 400,
            message: "URL instagram tidak diberikan!"
        });
    }
    try {
        ...
        res.status(500).json({ error: 'Gagal mengambil data instagram.' });
    }
});
...
router.get('/sfilemobi', async (req, res) => {
    ...
    if (!url) {
        return res.status(400).json({
            status: 400,
            message: "URL sfilemobi tidak diberikan!"
        });
    }
    try {
        const result = await sfilemobi(url);
        res.json(result);
    } catch (error) {
        console.error('Error fetching sfilemobi data:', error);
        res.status(500).json({ error: 'Gagal mengambil data sfilemobi.' });
    }
});
...
router.get('/play', async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ error: 'Gagal mengambil data play.' });
    }
});
...
router.get('/playaudio', async (req, res) => {
    ...
    try {
        const result = await playaudio(query);
        res.json(result);
    } catch (error) {
        console.error('Error fetching playaudio data:', error);
        res.status(500).json({ error: 'Gagal mengambil data playaudio.' });
    }
});
...
router.get('/playvideo', async (req, res) => {
    ...
    try {
        const result = await playvideo(query);
        res.json(result);
    } catch (error) {
        console.error('Error fetching playvideo data:', error);
        res.status(500).json({ error: 'Gagal mengambil data playvideo.' });
    }
});
...
router.get('/terabox', async (req, res) => {
    ...
    if (!url) {
        return res.status(400).json({
            status: 400,
            message: "URL terabox tidak diberikan!"
        });
    }
    try {
        ...
        res.status(500).json({ error: 'Gagal mengambil data terabox.' });
    }
});
